...
const LicenseTable = ({ licenses }) => {
  ...
  const [isWhiteOverlayVisible, setIsWhiteOverlayVisible] = useState(false); // Updated variable name
  ...
  const handleCreate = () => {
    ...
    setIsCreating(true);
    setIsWhiteOverlayVisible(true); // Updated variable name
  };
  ...
  const handleCreateSave = () => {
    if (currentLicense) {
      ...
      setIsCreating(false);
      setIsWhiteOverlayVisible(false); // Updated variable name
    }
  };
  ...
  return (
    <div className="license-table">
      ...
      {isWhiteOverlayVisible && currentLicense && ( // Updated variable name
        <div className="white-overlay"> {/* Updated class name */}
